...
public class StopWords {
    ...
    public static String processString(String searchString) {
        ...
        Set<String> stopWords = new HashSet<>(Arrays.asList(
                ...
                "find", "fire", "five", "fix", "fj", "fl", "fn", "fo", "followed", "following",
                "follows", "for", "former", "formerly", "forth", "forty", "found", "four", "fr", "from",
                "front", "fs", "ft", "fu", "full", "further", "fuck", "furthermore", "fy", "g", "ga", "gave", "ge",
                ...
                "says", "sc", "sd", "se", "search", "sec", "second", "secondly", "section", "see", "seeing", "seem",
